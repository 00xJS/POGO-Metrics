...
const CITIES = [["Rivertown", "Oregon"], ["Brookfield", "Nebraska"], ["Brightport", "Washington"], ["Maplefield", "Vermont"], ["Stonehaven", "Maine"], ["Fairview", "Idaho"], ["Westbrook", "Montana"], ["Greendale", "Iowa"]];
 ...
 * ("… <token>"). Almost certainly a merchandise SKU rather
